         ...
         <div class="col-md-5">
             <div class="row" style="margin-bottom: 5px;">
              ...
              <div class="row" style="margin-bottom: 5px;" id="carddiv">
                   ...
                   <div class="col-md-8"> 
                      <input type="radio" name="return_exchange" value="Return">Return
                      <input type="radio" name="return_exchange" value="Exchange">Exchange
                  </div>
              ...
              <div class="row" style="margin-bottom: 5px;">
                   ...
                   <div class="col-md-8"> 
                    <button type="submit" class="btn btn-danger btn-lg r-5" name="sale" style="height: 34px;background-image: linear-gradient(#137937, #267b1c);font-weight: bold;  font-size: 13px; text-align: center;"><i class="icon-documents4 mr-2"></i>Submit</button>
    ...
    function tableData(prodObjects){
        ...
        for(var prod in prodObjects){
           ...
           html = '<tr id="prod_'+prod+'">'
            ...
            +'<td id="qty_'+prod+'"><input type="number" value="'+qty+'" id="qt_'+prod+'" min="1"> </td><input type="hidden" name="qty[]" id="qty_input_'+prod+'" value="'+qty+'">'
...
//       var cashdiv=$("#cashdiv").val();
//       var carddiv=$("#carddiv").val();
//       if(payment=='cash')
//       {
//           $("#cashdiv").show();
//           $("#carddiv").hide();
...
//     var card_amt=$("#credit_debit").val();
   
//     var remaining=card_amt-cash_amt;
//     if(remaining > 0){
//       $("#cash").val(remaining.toFixed(2));
//     }else{
//       $("#cash").val(cash_amt);
//     }
