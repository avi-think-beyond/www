                     ...
                     <br>
                      ...
                      <div class="table-responsive">
                           ...
                           ?>
                                        <tr>
                                               <td><?php echo $i; ?></td>
                                                <td><input type="text" readonly=""class="form-control btn1" style="width: 135px;" value="<?php echo $row['barcode']; ?>" name="barcode[]"></td>
                                                <td><input type="text" readonly="" class="form-control btn1" style="width: 130px;" value="<?php echo $row['product_name']; ?>" name="product_name[]"></td>
                                                 <td><input type="text" readonly="" class="form-control btn1" style="width: 113px;" name="pro_code[]" value="<?php echo $row['product_code'] ;?>" ></td>
                                                <td><input type="text" readonly=""class="form-control btn1"style="width: 80px;" value="<?php echo $row['hsn_code']; ?>" name="hsn_code[]"></td>
                                                ...
                                                <td><input type="text" readonly="" class="form-control btn1" style="width: 94px;" name="manufacture[]" value="<?php echo $row['manfacturing_date'] ;?>" ></td>
                                                <td><input type="text" readonly="" class="form-control btn1" style="width: 94px;" name="expire[]" value="<?php echo $row['exp_date'] ;?>" ></td>
                                                <td><input type="text"  readonly="" class="form-control btn1" style="width: 60px;" name="adult[]" value="<?php echo $row['adult'] ;?>" ></td>
                                                <td><input type="text" class="form-control btn1" style="width: 60px;" readonly="" name="child[]" value="<?php echo $row['child'] ;?>" ></td>
                                                
                                                <td><input type="text" readonly="" class="form-control btn1" style="width: 70px;" name="brand[]" value="<?php echo $row['brand']; ?>" ></td>
                                                <td><input type="number" readonly="" class="form-control btn1" style="width: 60px;" name="size[]" value="<?php echo $row['size']; ?>" ></td>
                                                <td><input type="text" readonly="" class="form-control btn1" style="width: 70px;"name="colour[]" value="<?php echo $row['color']; ?>" ></td>
                                                <td><input type="text" readonly="" class="form-control btn1" style="width: 100px;" name="pro_type[]" value="<?php echo $row['product_type']; ?>" ></td>
