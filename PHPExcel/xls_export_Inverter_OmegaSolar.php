...
->setCellValue('A1',date("l jS \of F Y").' ENERGY PRODUCTION')
                ...
                ->setCellValue('F2', 'Block2 Inverter 1 (KWh)')
                ->setCellValue('G2', 'Block2 Inverter 2 (KWh)')
                ->setCellValue('H2', 'Block2 Inverter 3 (KWh)')
                ->setCellValue('I2', 'Block2 Inverter 4 (KWh)')
                
							  
							      ->setCellValue('J2', 'Total (KWh)')
								->setCellValue('K2'.$row, 'MFM - Enery Export (KWh)')
								->setCellValue('L2'.$row, 'MFM - Enery Import (KWh)')
								->setCellValue('M2'.$row, 'MFM - Enery Export Till date (KWh)')
								->setCellValue('N2'.$row, 'MFM - Enery Import Till date (KWh)')
