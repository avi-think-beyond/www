...
->setCellValue('A1',date("l jS \of F Y").' ENERGY PRODUCTION')
                ...
                ->setCellValue('D2', 'Block2_Inverter1 (KWh)')
                ->setCellValue('E2', 'Block2_Inverter2 (KWh)')
                ->setCellValue('F2', 'Block2_Inverter3 (KWh)')
                ->setCellValue('G2', 'Block2_Inverter4 (KWh)')
                ->setCellValue('H2', 'Block1_Inverter1 (KWh)')
                ->setCellValue('I2', 'Block1_Inverter2 (KWh)')
                ->setCellValue('J2', 'Block1_Inverter3 (KWh)')
                ->setCellValue('K2', 'Block1_Inverter4 (KWh)')
                ...
                // ->setCellValue('AY2', 'Inverter 50 (KWh)')
								...
								->setCellValue('M2'.$row, 'OG_1 - Enery Export (KWh)')
								->setCellValue('N2'.$row, 'OG_1 - Enery Import (KWh)')
								->setCellValue('O2'.$row, 'OG_1 - Enery Export Till date (KWh)')
								->setCellValue('P2'.$row, 'OG_1 - Enery Import Till date (KWh)')
