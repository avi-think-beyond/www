...
$objPHPExcel = new PHPExcel();
 ...
 $objPHPExcel->getActiveSheet()->getStyle('W2:Z2')->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'FFFF00'))))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
 $objPHPExcel->getActiveSheet()->getStyle('AA2:AD2')->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'E4AD7B'))))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
 $objPHPExcel->getActiveSheet()->getStyle('A2:AD2')->getFont()->setBold(true)->setSize(11);
 $objPHPExcel->getActiveSheet()->getStyle('A:AD')->getFont()->setBold(true)->setSize(10);
...
->setCellValue('A1',date("l jS \of F Y").' ENERGY PRODUCTION')
               ...
               ->setCellValue('B2', 'Block1 Inverter1 (KWh)')
                ...
                // ->setCellValue('AY2', 'Inverter 50 (KWh)')
								...
								->setCellValue('W2'.$row, 'OG MFM - Enery Export (KWh)')
								->setCellValue('X2'.$row, 'OG MFM - Enery Import (KWh)')
								->setCellValue('Y2'.$row, 'OG MFM - Enery Export Till date (KWh)')
								->setCellValue('Z2'.$row, 'OG MFM - Enery Import Till date (KWh)')
                               
								->setCellValue('AA2'.$row, 'Irradiation today [GHI] (kWh/m2)')
								->setCellValue('AB2'.$row, 'Irradiation today [DNI](kWh/m2)')
								->setCellValue('AC2'.$row, 'Specific Yield (kWh/kWp)')
								->setCellValue('AD2'.$row, 'Performance ratio (PR)');
...
$kwh_today='';
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AA'.$row, $irradiation);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AB'.$row, $irradiation_tilt1);
	$server_date_time='';
	$Meter_id='';
	$kwh_today='';
	 $irradiation='';
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AC'.$row, $specific_yield);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AD'.$row, $PR);
$Energy_Export_today='';
$Energy_import_today='';
$server_date_time='';
$Meter_id='';
