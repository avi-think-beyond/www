...
$objPHPExcel = new PHPExcel();
 ...
 $objPHPExcel->getActiveSheet()->getStyle('A2:P2')->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'E6B9B8'))))->getAlignment();
 $objPHPExcel->getActiveSheet()->getStyle('Q2:T2')->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'FFFF00'))))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
...
->setCellValue('A1',date("l jS \of F Y").' ENERGY PRODUCTION')
               ...
               ->setCellValue('B2', 'Block1 Inverter1 (KWh)')
                ...
                ->setCellValue('D2', 'Block2 Inverter 1 (KWh)')
                ->setCellValue('E2', 'Block2 Inverter 2 (KWh)')
                ->setCellValue('F2', 'Block3 Inverter1 (KWh)')
                ->setCellValue('G2', 'Block3 Inverter2 (KWh)')
                ->setCellValue('H2', 'Block4 Inverter1 (KWh)')
                ->setCellValue('I2', 'Block4 Inverter2 (KWh)')
                ->setCellValue('J2', 'Block5 Inverter1 (KWh)')
                ->setCellValue('K2', 'Block5 Inverter2 (KWh)')
                ->setCellValue('L2', 'Block6 Inverter1 (KWh)')
                ->setCellValue('M2', 'Block6 Inverter2 (KWh)')
                ->setCellValue('N2', 'Block7 Inverter1 (KWh)')
                ->setCellValue('O2', 'Block7 Inverter2 (KWh)')
                
                // ->setCellValue('Q2', 'Inverter 14 (KWh)')
                // ->setCellValue('R2', 'Inverter 15 (KWh)')
                // ->setCellValue('Q2', 'Inverter 18 (KWh)')
                ...
                // ->setCellValue('AY2', 'Inverter 50 (KWh)')
							      ...
							      ->setCellValue('P2', 'Total (KWh)')
								->setCellValue('Q2'.$row, 'OG MFM - Enery Export (KWh)')
								->setCellValue('R2'.$row, 'OG MFM - Enery Import (KWh)')
								->setCellValue('S2'.$row, 'OG MFM - Enery Export Till date (KWh)')
								->setCellValue('T2'.$row, 'OG MFM - Enery Import Till date (KWh)')
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('P'.$row, $ENERGY_Generated_today);
$server_date_time='';
$Meter_id='';
$kwh_today='';
	$row++;
