...
$objPHPExcel = new PHPExcel();
 ...
 $objPHPExcel->getActiveSheet()->getStyle('A2:AP2')->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'E6B9B8'))))->getAlignment();
 $objPHPExcel->getActiveSheet()->getStyle('AQ2:BF2')->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'FFFF00'))))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
 $objPHPExcel->getActiveSheet()->getStyle('BG2:BJ2')->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'E4AD7B'))))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
 $objPHPExcel->getActiveSheet()->getStyle('A2:BJ2')->getFont()->setBold(true)->setSize(11);
 $objPHPExcel->getActiveSheet()->getStyle('A:BJ')->getFont()->setBold(true)->setSize(10);
 $objPHPExcel->getActiveSheet()->getStyle('A:BJ')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
...
->setCellValue('A1',date("l jS \of F Y").' ENERGY PRODUCTION')
                ...
                ->setCellValue('C2', 'Block1 Inverter 2 (KWh)')
                ->setCellValue('D2', 'Block1 Inverter 3 (KWh)')
                ->setCellValue('E2', 'Block1 Inverter 4 (KWh)')
                ->setCellValue('F2', 'Block2 Inverter1 (KWh)')
                ->setCellValue('G2', 'Block2 Inverter2 (KWh)')
                ->setCellValue('H2', 'Block2 Inverter3 (KWh)')
                ->setCellValue('I2', 'Block2 Inverter4 (KWh)')
                ->setCellValue('J2', 'Block3 Inverter1 (KWh)')
                ->setCellValue('K2', 'Block3 Inverter2 (KWh)')
                ->setCellValue('L2', 'Block3 Inverter3 (KWh)')
                ->setCellValue('M2', 'Block3 Inverter4 (KWh)')
                ->setCellValue('N2', 'Block4 Inverter1 (KWh)')
                ->setCellValue('O2', 'Block4 Inverter2 (KWh)')
                ->setCellValue('P2', 'Block4 Inverter3 (KWh)')
                ->setCellValue('Q2', 'Block4 Inverter4 (KWh)')
                ->setCellValue('R2', 'Block5 Inverter1 (KWh)')
                ->setCellValue('S2', 'Block5 Inverter2 (KWh)')
                ->setCellValue('T2', 'Block5 Inverter3 (KWh)')
                ->setCellValue('U2', 'Block5 Inverter4 (KWh)')
                ->setCellValue('V2', 'Block6 Inverter1 (KWh)')
                ->setCellValue('W2', 'Block6 Inverter2 (KWh)')
                ->setCellValue('X2', 'Block6 Inverter3 (KWh)')
                ->setCellValue('Y2', 'Block6 Inverter4 (KWh)')
                ->setCellValue('Z2', 'Block7 Inverter1 (KWh)')
                ->setCellValue('AA2', 'Block7 Inverter2 (KWh)')
                ->setCellValue('AB2', 'Block7 Inverter3 (KWh)')
                ->setCellValue('AC2', 'Block7 Inverter4 (KWh)')
                ->setCellValue('AD2', 'Block8 Inverter1(KWh)')
                ->setCellValue('AE2', 'Block8 Inverter2 (KWh)')
                ->setCellValue('AF2', 'Block8 Inverter3 (KWh)')
                ->setCellValue('AG2', 'Block8 Inverter4 (KWh)')
                ->setCellValue('AH2', 'Block9 Inverter1 (KWh)')
                ->setCellValue('AI2', 'Block9 Inverter2 (KWh)')
                ->setCellValue('AJ2', 'Block9 Inverter3 (KWh)')
                ->setCellValue('AK2', 'Block9 Inverter4 (KWh)')
                ->setCellValue('AL2', 'Block10 Inverter1 (KWh)')
                ->setCellValue('AM2', 'Block10 Inverter2 (KWh)')
                ->setCellValue('AN2', 'Block10 Inverter3 (KWh)')
                ->setCellValue('AO2', 'Block10 Inverter4 (KWh)')
                
							  
							      ->setCellValue('AP2', 'Total (KWh)')
								->setCellValue('AQ2'.$row, 'OG1 MFM- Enery Export (KWh)')
								->setCellValue('AR2'.$row, 'OG1 MFM - Enery Import (KWh)')
								->setCellValue('AS2'.$row, 'OG1 MFM - Enery Export Till date (KWh)')
								->setCellValue('AT2'.$row, 'OG1 MFM- Enery Import Till date (KWh)')
                                ->setCellValue('AU2'.$row, 'OG2 MFM - Enery Export (KWh)')
                                ->setCellValue('AV2'.$row, 'OG2 MFM - Enery Import (KWh)')
                                ->setCellValue('AW2'.$row, 'OG2 MFM - Enery Export Till date (KWh)')
                                ->setCellValue('AX2'.$row, 'OG2 MFM - Enery Import Till date (KWh)')
                                 ->setCellValue('AY2'.$row, 'OG3 MFM - Enery Export (KWh)')
                                ->setCellValue('AZ2'.$row, 'OG3 MFM - Enery Import (KWh)')
                                ->setCellValue('BA2'.$row, 'OG3 MFM - Enery Export Till date (KWh)')
                                ->setCellValue('BB2'.$row, 'OG3 MFM - Enery Import Till date (KWh)')
                                 ->setCellValue('BC2'.$row, 'OG4 MFM - Enery Export (KWh)')
                                ->setCellValue('BD2'.$row, 'OG4 MFM - Enery Import (KWh)')
                                ->setCellValue('BE2'.$row, 'OG4 MFM - Enery Export Till date (KWh)')
                                ->setCellValue('BF2'.$row, 'OG4 MFM - Enery Import Till date (KWh)')
								->setCellValue('BG2'.$row, 'Irradiation today [GHI] (kWh/m2)')
								->setCellValue('BH2'.$row, 'Irradiation today [DNI](kWh/m2)')
								->setCellValue('BI2'.$row, 'Specific Yield (kWh/kWp)')
								->setCellValue('BJ2'.$row, 'Performance ratio (PR)');
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AP'.$row, $ENERGY_Generated_today);
$server_date_time='';
$Meter_id='';
$kwh_today='';
	$row++;
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('BG'.$row, $irradiation);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('BH'.$row, $irradiation_tilt1);
	$server_date_time='';
	$Meter_id='';
	$kwh_today='';
	 $irradiation='';
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AQ'.$row, $Energy_Export_today);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AR'.$row, $Energy_import_today);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AS'.$row, $Energy_Export_total);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AT'.$row, $Energy_import_total);
...
// $PR=0;  
// }
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AU'.$row, $Energy_Export_today);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AV'.$row, $Energy_import_today);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AW'.$row, $Energy_Export_total);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AX'.$row, $Energy_import_total);
$Energy_Export_today='';
$Energy_import_today='';
$server_date_time='';
$Meter_id='';
...
// $PR=0;  
// }
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AY'.$row, $Energy_Export_today);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AZ'.$row, $Energy_import_today);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('BA'.$row, $Energy_Export_total);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('BB'.$row, $Energy_import_total);
$Energy_Export_today='';
$Energy_import_today='';
$server_date_time='';
$Meter_id='';
...
// $PR=0;  
// }
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('BC'.$row, $Energy_Export_today);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('BD'.$row, $Energy_import_today);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('BE'.$row, $Energy_Export_total);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('BF'.$row, $Energy_import_total);
$Energy_Export_today='';
$Energy_import_today='';
$server_date_time='';
$Meter_id='';
...
$server_date_time=date('d-M-Y', strtotime($mfm_today_date));
 ...
 $objPHPExcel->setActiveSheetIndex(0)->setCellValue('BI'.$row, $specific_yield);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('BJ'.$row, $PR);
