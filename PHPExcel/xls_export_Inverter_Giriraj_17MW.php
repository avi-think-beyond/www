...
$objPHPExcel = new PHPExcel();
 ...
 $objPHPExcel->getActiveSheet()->getStyle('A2:S2')->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'E6B9B8'))))->getAlignment();
 $objPHPExcel->getActiveSheet()->getStyle('T2:W2')->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'FFFF00'))))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
 $objPHPExcel->getActiveSheet()->getStyle('X2:AA2')->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'E4AD7B'))))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
 $objPHPExcel->getActiveSheet()->getStyle('A2:AA2')->getFont()->setBold(true)->setSize(11);
 $objPHPExcel->getActiveSheet()->getStyle('A:AA')->getFont()->setBold(true)->setSize(10);
...
->setCellValue('A1',date("l jS \of F Y").' ENERGY PRODUCTION')
               ...
               ->setCellValue('B2', 'Inverter1 (KWh)')
                ->setCellValue('C2', 'Inverter2 (KWh)')
                ->setCellValue('D2', 'Inverter3 (KWh)')
                ->setCellValue('E2', 'Inverter4 (KWh)')
                ->setCellValue('F2', 'Inverter5 (KWh)')
                ->setCellValue('G2', 'Inverter6 (KWh)')
                ->setCellValue('H2', 'Inverter7 (KWh)')
                ->setCellValue('I2', 'Inverter8 (KWh)')
                ->setCellValue('J2', 'Inverter9 (KWh)')
                ->setCellValue('K2', 'Inverter10 (KWh)')
                ->setCellValue('L2', 'Inverter11 (KWh)')
                ->setCellValue('M2', 'Inverter12 (KWh)')
                ->setCellValue('N2', 'Inverter13 (KWh)')
                ->setCellValue('O2', 'Inverter14 (KWh)')
                ->setCellValue('P2', 'Inverter15 (KWh)')
                ->setCellValue('Q2', 'Inverter16 (KWh)')
                ...
                // ->setCellValue('Z2', 'Inverter 26 (KWh)')
                ...
                // ->setCellValue('AY2', 'Inverter 50 (KWh)')
							      ...
							      ->setCellValue('S2', 'Total (KWh)')
								->setCellValue('T2'.$row, 'OG_MFM - Enery Export (KWh)')
								->setCellValue('U2'.$row, 'OG_MFM - Enery Import (KWh)')
								->setCellValue('V2'.$row, 'OG_MFM - Enery Export Till date (KWh)')
								->setCellValue('W2'.$row, 'OG_MFM - Enery Import Till date (KWh)')
                               
								->setCellValue('X2'.$row, 'Irradiation today [GHI] (kWh/m2)')
								->setCellValue('Y2'.$row, 'Irradiation today [DNI](kWh/m2)')
								->setCellValue('Z2'.$row, 'Specific Yield (kWh/kWp)')
								->setCellValue('AA2'.$row, 'Performance ratio (PR)');
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('S'.$row, $ENERGY_Generated_today);
$server_date_time='';
$Meter_id='';
$kwh_today='';
	$row++;
	...
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('X'.$row, $irradiation);
	$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Y'.$row, $irradiation_tilt1);
	$server_date_time='';
	$Meter_id='';
	$kwh_today='';
	 $irradiation='';
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('T'.$row, $Energy_Export_today);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('U'.$row, $Energy_import_today);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('V'.$row, $Energy_Export_total);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('W'.$row, $Energy_import_total);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Z'.$row, $specific_yield);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AA'.$row, $PR);
$Energy_Export_today='';
$Energy_import_today='';
$server_date_time='';
$Meter_id='';
