...
$wmsj=0;
  ...
  $tiltline="B".$wmsrow;
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue($beta[$wmsdi].$wmsrow, $irradiation_tilt1);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue($beta[$wmsdi+1].$wmsrow, $irradiation_tilt1_sum);
  $girow=$wmsrow+1;
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue($beta[$wmsdi].$girow, $irradiation);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue($beta[$wmsdi+1].$girow, $irradiationsum);
...
$row=4;
               ...
               $select_Inverter_monthly123="SELECT today_date, SUM(kwh_today) AS kwh_today ,Inverter_id FROM Flexi_solar_inverters_daily WHERE Plant_id=$plant_id and DATE(today_date) BETWEEN '2017-01-01' and '$Current_year-$currentmonth-$Current_day' GROUP BY YEAR(today_date),MONTH(today_date),Inverter_id";
        ...
        
               {
                 ...
                 $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alpa[$month_kwh_run].$row, $kwh_today_month_all);
          ...
          $row=4;
               ...
               $select_Inverter_monthly_generationinverter="SELECT today_date, SUM(kwh_today) AS kwh_today ,Inverter_id,sum(plant_Inv_down_perc_avg) as plant_Inv_down_perc_avg FROM Flexi_solar_inverters_daily WHERE Plant_id=$plant_id and DATE(today_date) BETWEEN '2017-01-01' and '$Current_year-$currentmonth-$Current_day'  GROUP BY YEAR(today_date),MONTH(today_date)";
        ...
        
               {
                 ...
                 $kwh_today_month1_total +=$row161['kwh_today'];
 				 $objPHPExcel->setActiveSheetIndex(0)->setCellValue($beta[$Monthgenta].$Monthgentarow, $kwh_today_month1a);
...
$row=4;
               ...
               $select_Inverter_monthly_vertical_total="SELECT today_date, SUM(kwh_today) AS kwh_today ,Inverter_id FROM Flexi_solar_inverters_daily WHERE Plant_id=$plant_id and DATE(today_date) BETWEEN '2017-01-01' and '$Current_year-$currentmonth-$Current_day' GROUP BY Inverter_id";
              ...
              $objPHPExcel->setActiveSheetIndex(0)->setCellValue($month_total.$row, $kwh_todayvertical);
...
$select_Irr="SELECT SUM(irradiation) as irradiation,SUM(Global_irradiation) as Global_irradiation,today_date FROM Flexi_solar_wms_daily WHERE DATE(today_date) BETWEEN DATE('2017-01-01') AND DATE('$Current_year-$currentmonth-$Current_day')  and wms_id='1' and plant_id='$plant_id' group by YEAR(today_date),MONTH(today_date) order by today_date";
  ...
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alpa[$tilt_month].$month_tilt_row, $irradiation_tilt11);
  $tilt_month++;

  $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alpa[$GHI_month].$ghi_tilt_row, $irradiation1);
  $GHI_month++;
  $irradiation1='';
  $irradiation_tilt11='';
  ...
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alpa[$tilt_month].$month_tilt_row, $irradiation_tilt11_sum);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alpa[$GHI_month].$ghi_tilt_row, $irradiationsum1);
  $irradiationsum1='';
...
$select_Irr="SELECT SUM(irradiation) as irradiation,SUM(Global_irradiation) as Global_irradiation,today_date FROM Flexi_solar_wms_daily WHERE DATE(today_date) BETWEEN DATE('2017-01-01') AND DATE('$Current_year-$currentmonth-$Current_day')  and wms_id='1' and plant_id='$plant_id' group by YEAR(today_date) order by today_date";
  ...
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alpa[$tilti_star].$year_tilt_row, $irradiation_tilt11);
  $tilti_star++;

  $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alpa[$ghi_star].$ghi_tilt_row1, $irradiation1);
  $ghi_star++;
  $irradiation1='';
  $irradiation_tilt11='';
  ...
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alpa[$tilti_star].$year_tilt_row,  $irradiation_tilt11_sum);
  $objPHPExcel->setActiveSheetIndex(0)->setCellValue($alpa[$ghi_star].$ghi_tilt_row1, $irradiationsum1);
  $irradiationsum1='';
  $irradiation_tilt11_sum='';
