...
->setCellValue('A1',date("l jS \of F Y").' ENERGY PRODUCTION')
               ...
               ->setCellValue('B2', 'Block1 Inverter1 (KWh)')
                ...
                // ->setCellValue('AY2', 'Inverter 50 (KWh)')
								...
								->setCellValue('Q2'.$row, 'OG AUX - Enery Export (KWh)')
								->setCellValue('R2'.$row, 'OG AUX - Enery Import (KWh)')
								->setCellValue('S2'.$row, 'OG AUX - Enery Export Till date (KWh)')
								->setCellValue('T2'.$row, 'OG AUX - Enery Import Till date (KWh)')
