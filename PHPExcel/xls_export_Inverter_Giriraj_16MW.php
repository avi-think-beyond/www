...
$objPHPExcel = new PHPExcel();
 ...
 $objPHPExcel->getActiveSheet()->getStyle('A2:R2')->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'E6B9B8'))))->getAlignment();
 $objPHPExcel->getActiveSheet()->getStyle('S2:V2')->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'FFFF00'))))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
...
->setCellValue('A1',date("l jS \of F Y").' ENERGY PRODUCTION')
               ...
               ->setCellValue('B2', 'Inverter1 (KWh)')
                ...
                // ->setCellValue('AY2', 'Inverter 50 (KWh)')
							      ...
							      ->setCellValue('R2', 'Total (KWh)')
								->setCellValue('S2'.$row, 'OG_MFM - Enery Export (KWh)')
								->setCellValue('T2'.$row, 'OG_MFM - Enery Import (KWh)')
								->setCellValue('U2'.$row, 'OG_MFM - Enery Export Till date (KWh)')
								->setCellValue('V2'.$row, 'OG_MFM - Enery Import Till date (KWh)')
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('R'.$row, $ENERGY_Generated_today);
$server_date_time='';
$Meter_id='';
$kwh_today='';
	$row++;
