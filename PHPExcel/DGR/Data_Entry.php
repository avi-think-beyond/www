...
while($row16=mysqli_fetch_array($rs16))
{
       ...
       $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1].$row, $inverter_name);
...
$fo1 =$alpa[$row1];
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1].$row, 'Export_Final');
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+1].$row, 'Import_Final');
...
$fo10=$alpa[$row1+16];
$fo11=$alpa[$row1+17];
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+2].'2', 'GHI');
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+3].'2', 'Tilt Irradiance');
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+4].'2', 'Ambient Temperature');
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+7].'2', 'Solar Irradiance');
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+10].'2', 'Module Temperture');
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+13].'2', 'Wind Speed');
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+16].'2', 'Weather Corrected PR');
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+17].'2', 'Weather Corrected PR (compensated for load shedding)');
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+18].'2', 'GHI');
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+21].'2', 'Tilt');
...
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+2].'4', 'GHI');  
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+3].'4', 'Tilt Irrad');  
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+4].'4', 'Amb_Low');  
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+5].'4', 'Amb_Hig');  
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+6].'4', 'Amb_Avg');  
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+7].'4', 'Mod_Low');  
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+8].'4', 'Mod_Hig');  
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+9].'4', 'Mod_Avg');  
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+10].'4', 'Sol_Low');  
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+11].'4', 'Sol_Hig');  
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+12].'4', 'Sol_Avg');  
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+13].'4', 'Win_Low');  
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+14].'4', 'Win_Hig');  
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+15].'4', 'Win_Avg');  
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($fo4.'1', 'Analog Data of Plant Day Wise');  

$fo3= $alpa[$row1+15];
 
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+18].'4', 'GHI Without considering Grid outage'); 

$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+19].'4', 'Loss of GHI for the day');  
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+20].'4', 'GHI for the day with grid outage period taken out'); 
$objPHPExcel->getActiveSheet()->getColumnDimension($alpa[$row1+20])->setWidth(20);   
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+21].'4', 'Tilt Without considering Grid outage
');  
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+22].'4', 'Loss of Tilt for the day');  
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$row1+23].'4', 'Tilt for the day with grid outage period taken out');
$objPHPExcel->getActiveSheet()->getColumnDimension($alpa[$row1+23])->setWidth(20);    

$invicount=$row1+24;
$invicountmer1=$alpa[$invicount].'2';
 $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$invicount].'2', 'Inverter Efficiency');

for ($i=0; $i<count($Inverter_id) ; $i++) { 
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$invicount].$row, $inverter_name1[$i]);
         $objPHPExcel->getActiveSheet()->getColumnDimension($alpa[$invicount])->setWidth(15);

 $invicount++;
}

$las=$alpa[$invicount-2];
$invicountmer2=$alpa[$invicount-1].'2';
$invicc=$alpa[$invicount-2].'3';

$invicountmer3=$alpa[$invicount-2].'4';
 ...
 $select_Inverter_monthly123="SELECT today_date,kwh_today ,Inverter_id,Inverter_start_time,Inverter_end_time FROM Flexi_solar_inverters_daily WHERE Plant_id=$solar_plant_id and DATE(today_date) BETWEEN '2017-01-01' and '$Current_year-$currentmonth-$Current_day' GROUP BY DATE(today_date),plant_id ORDER BY plant_id,today_date" ;
        ...
        
               {
                ...
                $objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row, $Month_date[$cnt_da]);
                $objPHPExcel->setActiveSheetIndex(2)->setCellValue('B'.$row, $Month_date_time);
                $objPHPExcel->setActiveSheetIndex(2)->setCellValue('C'.$row, '05:08');
                $objPHPExcel->setActiveSheetIndex(2)->setCellValue('D'.$row, '18:06');
                $row++;
                $Month_date_time='';
                $cnt_da++;
               }
...
$select_Inverter_monthly123="SELECT today_date,SUM(kwh_today) as kwh_today ,Inverter_id FROM Flexi_solar_inverters_daily WHERE Plant_id=$solar_plant_id and DATE(today_date) BETWEEN '2017-01-01' and '$Current_year-$currentmonth-$Current_day' GROUP BY DATE(today_date),Inverter_id order by Inverter_id, today_date " ;
                $rs161=mysqli_query($conn2,$select_Inverter_monthly123) or die("error 101".mysqli_error($conn2));
                while($row161=mysqli_fetch_array($rs161))
               ...
               $countid =$rcnt;
                ...
                $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$run].$row, $kwh_today);
                // $objPHPExcel->setActiveSheetIndex(2)->setCellValue('B'.$row, $Month_date_time);
     ...
     while($row16=mysqli_fetch_array($rs16))
      {
        ...
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($fo1.$row, $Energy_Export_total);
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($fo2.$row, $Energy_import_total);
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($Weather_Corrected_PR_row.$row, $Weather_Corrected_PR);
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($Weather_Corrected_PR_load_row.$row, $Weather_Corrected_PR);
        $Energy_Export_total='';
        $Energy_import_total ='';
...
$select_Irr="SELECT SUM(irradiation) as irradiation,SUM(Global_irradiation) as Global_irradiation,SUM(Ambient_temp_min) as Ambient_temp_min,SUM(Ambient_temp_max) as Ambient_temp_max, SUM(Ambient_temp_AVG) as Ambient_temp_AVG, SUM(module1_tmp_min) as module1_tmp_min ,SUM(module1_tmp_max) as module1_tmp_max,SUM(module1_tmp_AVG) as module1_tmp_AVG, SUM(wind_speed_min) as wind_speed_min ,SUM(wind_speed_max) as wind_speed_max,SUM(wind_speed_AVG), wind_speed_AVG ,SUM(irradiation_tilt1_min) as irradiation_tilt1_min, SUM( irradiation_tilt1_max) as  irradiation_tilt1_max,SUM(irradiation_horizantal_AVG) as irradiation_horizantal_AVG,today_date FROM Flexi_solar_wms_daily WHERE DATE(today_date) BETWEEN DATE('2017-01-01') AND DATE('$Current_year-$currentmonth-$Current_day')  and wms_id='1' and plant_id='$solar_plant_id' GROUP BY DATE(today_date),plant_id ORDER BY plant_id,today_date";
  ...
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($fo4.$row, $GHI);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($fo5.$row, $irradiation_tilt11);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($Amb_Low_row.$row, $Amb_Low);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($Amb_Hig_row.$row, $Amb_Hig);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($Amb_Avg_row.$row, $Amb_Avg);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($Sol_Low_row.$row, $Sol_Low);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($Sol_Hig_row.$row, $Sol_Hig);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($Sol_Avg_row.$row, $Sol_Avg);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($Win_Low_row.$row, $win_Low);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($Win_Hig_row.$row, $win_Hig);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($Win_Avg_row.$row, $win_Avg);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($Mod_Low_row.$row, $Mod_Low);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($Mod_Hig_row.$row, $Mod_Hig);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($Mod_Avg_row.$row, $Mod_Avg);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($GHI_Without_considering_Grid_outage_row.$row, $sumGHi_Loss);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($Loss_of_GHI_for_the_day_row.$row, $irr_during_grid_down[$cunt]);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($GHI_period_taken_out_row.$row, $GHI);

 $objPHPExcel->setActiveSheetIndex(2)->setCellValue($Tilt_Without_outage_row.$row, $sumirradti_Loss);
 $objPHPExcel->setActiveSheetIndex(2)->setCellValue($Loss_of_Tilt_for_the_row.$row, $irr_during_grid_down[$cunt]);
 $objPHPExcel->setActiveSheetIndex(2)->setCellValue($Tilt_taken_out.$row, $irradiation_tilt11);
...
$objPHPExcel->getActiveSheet()->getStyle('A1'.':'.$las.$lastwo)->applyFromArray(array(
            'borders' => array(
                'allborders' => array(
                    'style' => PHPExcel_Style_Border::BORDER_HAIR
                )
