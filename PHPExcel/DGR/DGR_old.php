...
for($di=1;$di<=31;$di++){
  $currdate=date('d');
if($di > $currdate){
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$j].''.$row ,'Total');
$dailyInverterline= $alpa[$j].$row;
$da1245= $alpa[$j].'2';

break;
}else{
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$j].''.$row , $di.'-'.date('F'));
...
while($row16=mysqli_fetch_array($rs16))
{
       ...
       $objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row, $inverter_name);
   ...
   $objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'Generation @ Inverter (kWh) ');
...
//    $ji++;
//    $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$ji].''.$row ,'Total');
//    $mer2=$alpa[$ji].($row-1);
...
$month_total=$alpa[$ji];
  ...
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$ji+2].'2',' Yearly Generation');
  $ymer1=$alpa[$ji+2].'2';
  $ymer3=$alpa[$ji+2].'3';

  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$ji+2].'3',' Inverter Name');
// $month_count_123=0;
  $yearcoun= $ji+3;
...
FROM   Flexi_solar_inverters_daily where Plant_id=$plant_id GROUP by YEAR(today_date)";
        ...
        
               {
                ...
                $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$yearcoun].'3' ,$YEARDATE1);
                ...
                $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$yearcoun].'3' ,'Cumulative');
...
for ($xcc=1 ; $xcc <= count($Inverter_id); $xcc++) {
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$ji+3] .$row , $inverter_name1[$xcc]);
          $row++;

$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$ji+3].$row,'Generation @ Inverter (kWh) ');

}

$row1=$row+1;

$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$ji+3].$row1,'Generation @ 33kV Export');
$row1=$row1+1;

$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$ji+3].$row1,'Load Shedding @ 380 V');

$row1=$row1+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$ji+3].$row1,'Equiv Load Shedding Loss @ 33kV');
$yearly_load_line=$beta[$ji+3].$row1;
$row1=$row1+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$ji+3].$row1,'Tilt Irradiance');
$yearly_tilt_line=$beta[$ji+3].$row1;
$row1=$row1+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$ji+3].$row1,'GHI');
$row1=$row1+1;
$aclosses=$row1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$ji+3].$row1,'AC Losses + Day Aux. Consumption');
$yearly_aclosses_line=$beta[$ji+3].$row1;

$row1=$row1+1;
$plantrow=$row1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$ji+3].$row1,'% Plant Availability');
$yearly_pa_line=$beta[$ji+3].$row1;

$row1=$row1+1;
$gridrow=$row1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$ji+3].$row1,'% Grid Availability');
$row1=$row1+1;
$prrow=$row1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$ji+3].$row1,'% PR');
$row1=$row1+1;
$cufrow=$row1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$ji+3].$row1,'% CUF');
$row1=$row1+1;
$prload=$row1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$ji+3].$row1,'% PR (Compensated for Load Shedding)');
$row1=$row1+1;
$cufload=$row1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$ji+3].$row1,'% CUF (Compensated for Load Shedding)');
...
$row33kv=$row+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row33kv,'Generation @ 33kV Export');
$row=$row33kv+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'Load Shedding @ 380 V');
$row=$row+1;
$dailylineinnerline='A'.$row;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'Equiv Load Shedding Loss @ 33kV');
$row=$row+1;
$wmsrow=$row;
$tiltcolor='A'.$row;

$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'Tilt Irradiance');
$row=$row+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'GHI');
$row=$row+1;
$aclosescolor='A'.$row;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'AC Losses + Day Aux. Consumption');
$row=$row+1;
$pacolor='A'.$row;

$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'% Plant Availability');
$row=$row+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'% Grid Availability');
$row=$row+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'% PR');
$row=$row+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'% CUF');
$row=$row+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'% PR (Compensated for Load Shedding)');
$row=$row+1;
$loadsheddingcolor='A'.$row;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'% CUF (Compensated for Load Shedding)');

$row=$row+2;
$tenmwrow=$row;

$tenmrowcolor='A'.$row;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'10 MW');

$row=$row+1;
$daywiserowinverter=$row;
$daywiserowinvertercolor='A'.$row;

$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'Day Wise Total Generation @ Inverter');
$row=$row+1;
$daywiserowmfm=$row;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'Day Wise Total Generation @ 33kV Meter');
$row=$row+1;
...
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'Day Performances');

$day_performance_gridline= 'A'.$row;
$day_performance_gridline2= 'B'.$row;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('B'.$row,date('d-F'));
...
$geninverter=$row;
$geninverter1='A'.$row;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'Generation @ Inverter');
$row=$row+1;
$genmfm=$row;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'Generation @ SPD Meter');
$row=$row+1;
$aclossesperday=$row;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('A'.$row,'AC Losses + Day Aux. Consumption');
$row=$row+1;
...
$wmsj=0;
  ...
  $tiltline="B".$wmsrow;
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$wmsdi].$wmsrow, $irradiation_tilt1);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$wmsdi+1].$wmsrow, $irradiation_tilt1_sum);
  $girow=$wmsrow+1;
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$wmsdi].$girow, $irradiation);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$wmsdi+1].$girow, $irradiationsum);
...
$currdate=date('d');
  ...
  break;
          ...
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$j].''.$tenmwrow , $mfmdi.'-'.date('F'));
     ...
     while($row16=mysqli_fetch_array($rs16))
      {
        ...
        $COUNT=date('d');
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$mfmdi].$row33kv, $Energy_Export_today);

        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$mfmdi].$daywiserowmfm, $Energy_Export_today);
        $daywisemfmcolor=$beta[$mfmdi].$daywiserowmfm;
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue('B'.$genmfm, end($Energy_Export_today2));


      
        }
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$mfmdi+1].$row33kv, $Energy_Export_today1);
        $row33=$row33kv+1;
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$mfmdi].$row33,'--');
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$mfmdi+1].$row33,'--');
        $row331=$row33+1;
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$mfmdi].$row331,'--');
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$mfmdi+1].$row331,'--');
...
while($fetch=mysqli_fetch_array($result)) {
  ...
  if($fetch['DC_CUF'] <= 100) {
        ...
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$prcount].$prrow,number_format($Plant_PR,2).'%');
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$prcount1].$prload,'--');
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue('B'.$prloadperday,'--');

        $grid_lines_inverter=$beta[$DC_CUFcount1+1].$cufload;
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$DC_CUFcount].$cufrow,number_format($DC_CUF,2).'%');
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$DC_CUFcount1].$cufload,'--');
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue('B'.$cufloadperday,'--');
        $geninverter2= 'B'.$cufloadperday;
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$Plant].$plantrow,number_format($Plant_Inv_availlabilty_loss_perc,2).'%');
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$Plant1].$plantrow,number_format($Plant_Inv_availlabilty_loss_perc,2).'%');


        $objPHPExcel->setActiveSheetIndex(2)->setCellValue('B'.$paperday,number_format($Plant_Inv_availlabilty_loss_perc,2).'%');

        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$grid].$gridrow,number_format($Grid_availlabilty_loss_perc,2).'%');
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$grid1].$gridrow,number_format($Grid_availlabilty_loss_perc,2).'%');
        $objPHPExcel->setActiveSheetIndex(2)->setCellValue('B'.$gridperday,number_format($Grid_availlabilty_loss_perc,2).'%');
...
$grid1++;
 ...
 $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$prcount].$prrow,number_format($Plant_PR_sum,2).'%');
 $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$prcount1].$prload,'--');
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('B'.$prperday,number_format($Plant_PR,2).'%');

$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$DC_CUFcount].$cufrow,number_format($DC_CUF_sum,2).'%');
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$DC_CUFcount1].$cufload,'-');
$objPHPExcel->setActiveSheetIndex(2)->setCellValue('B'.$curperday,number_format($DC_CUF,2).'%');


$Plant_Inv_availlabilty_loss_perc_sum=$Plant_Inv_availlabilty_loss_perc_sum/$daycount;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$Plant1].$plantrow,number_format($Plant_Inv_availlabilty_loss_perc_sum,2).'%');
$Grid_availlabilty_loss_perc_sum=$Grid_availlabilty_loss_perc_sum/$daycount;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$grid].$gridrow,number_format($Grid_availlabilty_loss_perc_sum,2).'%');
...
$row = 4;
      ...
      for ($xc=1 ; $xc <= count($Inverter_id); $xc++) {
           ...
           while($row16=mysqli_fetch_array($rs16))
        
               {
                 ...
                 $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$x].$row , $kwh_today);
                 $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$x].$aclosses , $AC_Losses_Day_Aux_Consumption.'%');
                 $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$x+1].$aclosses , $AC_Losses_Day_Aux_Consumption_sum.'%');
                 $objPHPExcel->setActiveSheetIndex(2)->setCellValue('B'.$aclossesperday , end($AC_Losses_Day_Aux_Consumption_sum1).'%');
      ...
      if ($row>count($Inverter_id)) {
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$x+1].$row , $kwh_today_sum);
          $row=4;
            }
       ...
       while($row16=mysqli_fetch_array($rs16))
        {
           ...
           $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$di].$row , $kwh_today);
           $row++;
           $kwh_today='';
         } 
          ...
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$di+2] .$row , ' P1SnW3910');
          ...
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$di+2] .$row , 'MONTH WISE GENERATION DETAILS( Yearly Generation ) Year '.$Previous_year.'-'.$Current_year);
           
    
          $row=3;
          
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$di+2] .$row , 'Inverter Name');
          $mer3=$beta[$di+2].$row;
          ...
          $row=4;
          for ($xc=1 ; $xc <= count($Inverter_id); $xc++) {
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$di+2].$row , $inverter_name1[$xc]);
          $row++;
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$di+2].$row,'Generation @ Inverter (kWh) ');
...
$Monthgentarow=$row;
 $row=$row+1;
 $month_MFM_Row=$row;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$di+2].$row,'Generation @ 33kV Export');
 $row=$row+1;
 $load_shedding_row0=$row;
$load_shedding_row=$row+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$di+2].$row,'Load Shedding @ 380 V');
$load_sehd_apl=$di+2;
$acl_mon=$load_sehd_apl;
$row=$row+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$di+2].$row,'Equiv Load Shedding Loss @ 33kV');
$monthly_inverter_line=$beta[$di+2].$row;
 ...
 $pr1_row=$row+7;
 $cuf1_row=$row+8;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$di+2].$row,'Tilt Irradiance');
 $monthly_tilt_line=$beta[$di+2].$row;

  $row=$row+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$di+2].$row,'GHI');
$row=$row+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$di+2].$row,'AC Losses + Day Aux. Consumption');
$monthly_aclosses_line=$beta[$di+2].$row;

$row=$row+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$di+2].$row,'% Plant Availability');
$monthly_pa_line=$beta[$di+2].$row;
$row=$row+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$di+2].$row,'% Grid Availability');
$row=$row+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$di+2].$row,'% PR');
$row=$row+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$di+2].$row,'% CUF');
$row=$row+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$di+2].$row,'% PR (Compensated for Load Shedding)');
$row=$row+1;
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$di+2].$row,'% CUF (Compensated for Load Shedding)');
  ...
  if($di > $currdate){
    ...
    $row=$inv_cnt+3;
       ...
       for ($xc=1 ; $xc <= count($Inverter_id); $xc++) {
           ...
           $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$j].$row , $kwh_today);

           $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$j].$daywiserowinverter , $kwh_today);
...
$row=4;
               ...
               $select_Inverter_monthly123="SELECT today_date, SUM(kwh_today) AS kwh_today ,Inverter_id FROM Flexi_solar_inverters_daily WHERE Plant_id=$plant_id and DATE(today_date) BETWEEN '$Previous_year-01-01' and '$Current_year-$currentmonth-$Current_day' GROUP BY YEAR(today_date),MONTH(today_date),Inverter_id";
        ...
        
               {
                 ...
                 $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$month_kwh_run].$row, $kwh_today_month_all);
              if($Inverter_id_all == count($inverter_name1)){
                 $month_kwh_run++; 
                 $row=3;
               }
               $row++;
        ...
        
               {
                 ...
                 $AC_Losses_Day_Aux_Consumption=round($row16['plant_Inv_down_perc_avg'],2);
                 $AC_Losses_Day_Aux_Consumption_sum +=round($row16['plant_Inv_down_perc_avg'],2);
                 $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$acl_mon].$ac_loss_row,$AC_Losses_Day_Aux_Consumption);
                  $acl_mon++;
                 $AC_Losses_Day_Aux_Consumption='';
                 }
                  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$acl_mon].$ac_loss_row, $AC_Losses_Day_Aux_Consumption_sum);



          $row=4;

               $select_Inverter_monthly_generationinverter="SELECT today_date, SUM(kwh_today) AS kwh_today ,Inverter_id,sum(plant_Inv_down_perc_avg) as plant_Inv_down_perc_avg FROM Flexi_solar_inverters_daily WHERE Plant_id=$plant_id and DATE(today_date) BETWEEN '$Previous_year-01-01' and '$Current_year-$currentmonth-$Current_day'  GROUP BY YEAR(today_date),MONTH(today_date)";
                $rs161=mysqli_query($conn2,$select_Inverter_monthly_generationinverter) or die("error 101".mysqli_error($conn2));
                while($row161=mysqli_fetch_array($rs161))
        
               {
                
                 $kwh_today_month1a =$row161['kwh_today'];
                 $kwh_today_month1_total +=$row161['kwh_today'];
         $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$Monthgenta].$Monthgentarow, $kwh_today_month1a);
             
               
               $Monthgenta++;
               $kwh_today_month1a='';
               }
               $objPHPExcel->setActiveSheetIndex(2)->setCellValue($beta[$Monthgenta].$Monthgentarow, $kwh_today_month1_total);
...
$row=4;
              ...
              $objPHPExcel->setActiveSheetIndex(2)->setCellValue($month_total.$row, $kwh_todayvertical);
              $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$yearly_cumm].$row, $kwh_todayvertical);
              $row++;
              $kwh_todayvertical='';
              }
...
$Load_Shedding_monthly='--';
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$load_sehd_apl].$load_shedding_row, $Load_Shedding_monthly);
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$load_sehd_apl].$load_shedding_row0, $Load_Shedding_monthly);
...
$select_MFM_MONTHLY1="SELECT SUM(Energy_Export_today) AS Energy_Export_today,Plant_PR,today_date,DC_CUF,Plant_Inv_availlabilty_loss_perc,Grid_availlabilty_loss_perc FROM Flexi_solar_MFM_daily WHERE DATE(today_date) BETWEEN DATE('2017-01-01') AND DATE('$Current_year-$currentmonth-$Current_day') and MFM_Cumulative='1' and plant_id='$plant_id' group by YEAR(today_date),MONTH(today_date) order by today_date";
                ...
                $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$mfmnew].$month_MFM_Row, $Energy_Export_today);
                $row++;
                $mfmnew++;
                $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$mfmnew].$month_MFM_Row, $Energy_Export_today_sum);
                $Energy_Export_today='';
                }
...
$select_MFM_MONTHLY1="SELECT SUM(Energy_Export_today) AS Energy_Export_today,SUM(Plant_PR) as Plant_PR,today_date,SUM(DC_CUF) as DC_CUF,SUM(Plant_Inv_availlabilty_loss_perc) as Plant_Inv_availlabilty_loss_perc,SUM(Grid_availlabilty_loss_perc) as Grid_availlabilty_loss_perc,count(today_date) as cnt_days FROM Flexi_solar_MFM_daily WHERE DATE(today_date) BETWEEN DATE('2017-01-01') AND DATE('$Current_year-$currentmonth-$Current_day') and MFM_Cumulative='1' and plant_id='$plant_id' group by YEAR(today_date),MONTH(today_date) ";
 ...
 //  else{
  ...
  // if($row16['DC_CUF'] <= 100) {
          ...
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$pa_month].$pa_row, $Plant_Inv_availlabilty_loss_perc1_ave.'%');
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$Ga_month].$ga_row, $Grid_availlabilty_loss_perc1_ave.'%');
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$PR_month].$pr_row, number_format($Plant_PR1,2).'%');
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$cuf_month].$cuf_row, number_format($DC_CUF12,2).'%');
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$pr1_month].$pr1_row,'--');
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$cuf1_month].$cuf1_row,'--');
      ...
      $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$pa_month].$pa_row, number_format($Plant_Inv_availlabilty_loss_perc_sum1_ave,2).'%');

      $Grid_availlabilty_loss_perc1_sum_ave=round($Grid_availlabilty_loss_perc1_sum/$inve_count,2);
      $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$Ga_month].$ga_row, number_format($Grid_availlabilty_loss_perc1_sum_ave,2).'%');

      $Plant_PR_sum1=$Plant_PR1_sum1/$inve_count;
      $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$PR_month].$pr_row, number_format($Plant_PR_sum1,2).'%');

      $DC_CUF_sum1=round($DC_CUF_sum1/$inve_count,2);
      $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$cuf_month].$cuf_row, number_format($DC_CUF_sum1,2).'%');
...
$select_Irr="SELECT SUM(irradiation) as irradiation,SUM(Global_irradiation) as Global_irradiation,today_date FROM Flexi_solar_wms_daily WHERE DATE(today_date) BETWEEN DATE('2017-01-01') AND DATE('$Current_year-$currentmonth-$Current_day')  and wms_id='1' and plant_id='$plant_id' group by YEAR(today_date),MONTH(today_date) order by today_date";
  ...
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$tilt_month].$month_tilt_row, $irradiation_tilt11);
  $tilt_month++;

  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$GHI_month].$ghi_tilt_row, $irradiation1);
  $GHI_month++;
  $irradiation1='';
  $irradiation_tilt11='';
  ...
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$tilt_month].$month_tilt_row, $irradiation_tilt11_sum);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$GHI_month].$ghi_tilt_row, $irradiationsum1);
  $irradiationsum1='';
...
$yearlyfirstline= $alpa[$yearly_inv_star].$row;
               ...
               $select_Inverter_monthly1234="SELECT today_date, SUM(kwh_today) AS kwh_today ,Inverter_id,sum(plant_Inv_down_perc_avg) as plant_Inv_down_perc_avg FROM Flexi_solar_inverters_daily WHERE Plant_id=$plant_id and DATE(today_date) BETWEEN '$Previous_year-01-01' and '$Current_year-$currentmonth-$Current_day' GROUP BY YEAR(today_date),Inverter_id";
        ...
        
               {
                $date_today=$row112['today_date']; 
                 ...
                 $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$yearly_inv_star].$row, $kwh_today_yearly);
...
$ac_loss_row1=$ghi_tilt_row1+1;
 ...
 $cuf1_row1=$pr1_row1+1;
               ...
               $select_Inverter_monthly123_horizontal="SELECT today_date, SUM(kwh_today) AS kwh_today ,Inverter_id FROM Flexi_solar_inverters_daily WHERE Plant_id=$plant_id and DATE(today_date) BETWEEN '$Previous_year-01-01' and '$Current_year-$currentmonth-$Current_day' GROUP BY YEAR(today_date)";
         ...
         $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$Generation_Inverte_star].$row_inve, $kwh_today_year1);
             
               
               $Generation_Inverte_star++;
               }
              $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$Generation_Inverte_star].$row_inve, $kwh_today_year1_total);
...
$select_MFM_Yearly1="SELECT SUM(Energy_Export_today) AS Energy_Export_today,Plant_PR,today_date,DC_CUF,Plant_Inv_availlabilty_loss_perc,Grid_availlabilty_loss_perc FROM Flexi_solar_MFM_daily WHERE DATE(today_date) BETWEEN DATE('2017-01-01') AND DATE('$Current_year-$currentmonth-$Current_day') and MFM_Cumulative='1' and plant_id='$plant_id' group by YEAR(today_date) order by today_date";
                ...
                $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$Generation_33kv_star].$gene_inv_year, $Energy_Export_today_yearly);
                ...
                $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$Generation_33kv_star].$gene_inv_year, $Energy_Export_today_sum_yearly);
$yrcntdeviation=$yearcount12;
$yrcnt=$yearcount12+1;
for ($j1=1; $j1 <=$yrcnt ; $j1++) { 
$Load_Shedding_Yearly1='--';
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$Load_Shedding_star].$ls_year, $Load_Shedding_Yearly1);
$objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$Load_Shedding_star].$ells_year, $Load_Shedding_Yearly1);
...
$select_MFM_MONTHLY1="SELECT SUM(Energy_Export_today) AS Energy_Export_today,avg(Plant_PR) as Plant_PR,today_date,avg(DC_CUF) as DC_CUF,avg(Plant_Inv_availlabilty_loss_perc) as Plant_Inv_availlabilty_loss_perc,avg(Grid_availlabilty_loss_perc) as Grid_availlabilty_loss_perc,count(YEAR(today_date)) as cnt_days,today_date FROM Flexi_solar_MFM_daily WHERE DATE(today_date) BETWEEN DATE('2017-01-01') AND DATE('$Current_year-$currentmonth-$Current_day') and MFM_Cumulative='1' and plant_id='$plant_id' group by YEAR(today_date)";
  ...
  if ($row16['Plant_Inv_availlabilty_loss_perc']<=100) {
    ...
    $Plant_PR1_sum11 +=$Plant_PR1;
          ...
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$pa_star].$pa_row1, number_format($Plant_Inv_availlabilty_loss_perc1_ave,2).'%');
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$ga_star].$ga_row1, number_format($Grid_availlabilty_loss_perc1_ave,2).'%');
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$pr_star].$pr_row1, number_format($Plant_PR1,2).'%');
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$cuf_star].$cuf_row1, number_format($DC_CUF12,2).'%');
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$pf1_star].$pr1_row1,'--');
          $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$cuf1_star].$cuf1_row1,'--');
      ...
      $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$pa_star].$pa_row1, number_format($Plant_Inv_availlabilty_loss_perc_sum11,2).'%');

      $Grid_availlabilty_loss_perc1_sum_ave=round($Grid_availlabilty_loss_perc1_sum1/$yrcntdeviation,2);
      $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$ga_star].$ga_row1, number_format($Grid_availlabilty_loss_perc1_sum_ave,2).'%');

      $Plant_PR_sum1=round($Plant_PR1_sum11/$yrcntdeviation,2);
      $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$pr_star].$pr_row1, number_format($Plant_PR_sum1,2).'%');

      $DC_CUF_sum1=round($DC_CUF_sum11/$yrcntdeviation,2);
      $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$cuf_star].$cuf_row1, number_format($DC_CUF_sum1,2).'%');
...
$select_Irr="SELECT SUM(irradiation) as irradiation,SUM(Global_irradiation) as Global_irradiation,today_date FROM Flexi_solar_wms_daily WHERE DATE(today_date) BETWEEN DATE('2017-01-01') AND DATE('$Current_year-$currentmonth-$Current_day')  and wms_id='1' and plant_id='$plant_id' group by YEAR(today_date) order by today_date";
  ...
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$tilti_star].$year_tilt_row, $irradiation_tilt11);
  $tilti_star++;

  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$ghi_star].$ghi_tilt_row1, $irradiation1);
  $ghi_star++;
  $irradiation1='';
  $irradiation_tilt11='';
  ...
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$tilti_star].$year_tilt_row,  $irradiation_tilt11_sum);
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$ghi_star].$ghi_tilt_row1, $irradiationsum1);
  $irradiationsum1='';
  $irradiation_tilt11_sum='';
$yearly_grid_line= $alpa[$ghi_star].$ells_year;


$select_Inverter_YEARlylossed="SELECT today_date, SUM(kwh_today) AS kwh_today ,Inverter_id,sum(plant_Inv_down_perc_avg) as plant_Inv_down_perc_avg FROM Flexi_solar_inverters_daily WHERE Plant_id=$plant_id and DATE(today_date) BETWEEN '$Previous_year-01-01' and '$Current_year-$currentmonth-$Current_day' GROUP BY YEAR(today_date)";
        ...
        
               {
                 ...
                 $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$acloses_star].$ac_loss_row1, $AC_Losses_Day_Aux_Consumption123);
                  $acloses_star++;
                 $AC_Losses_Day_Aux_Consumption123='';
                 }
                  $objPHPExcel->setActiveSheetIndex(2)->setCellValue($alpa[$acloses_star].$ac_loss_row1, $AC_Losses_Day_Aux_Consumption_sum123);
...
$objPHPExcel->getActiveSheet()->getStyle($yearlastline.":".$yearlsline)->applyFromArray(array(
  ...
  $objPHPExcel->setActiveSheetIndex(2)->setCellValue('B'.$geninverter , end($kwh_today12));
...
$objPHPExcel->getActiveSheet()->getStyle('A'.$tenmwrow.":".$tenmwcolor)->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'F2DDDC'))))->getAlignment();
 ...
 $objPHPExcel->getActiveSheet()->getStyle($mer1.":".$mer2)->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'F2DDDC'))))->getAlignment();
  $objPHPExcel->getActiveSheet()->getStyle($me1.":".$me2)->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'F2DDDC'))))->getAlignment();
...
$objPHPExcel->getActiveSheet()->getStyle("$day_performance_gridline")->applyFromArray($CStyle);
$objPHPExcel->getActiveSheet()->getStyle("$day_performance_gridline2")->applyFromArray($CStyle);
...
$objPHPExcel->getActiveSheet()->getStyle($mer3.":".$mer4)->getFont()->setBold(true)->setName('Gisha')->setSize(10);
$objPHPExcel->getActiveSheet()->getStyle($ymer3.":".$ymer4)->getFont()->setBold(true)->setName('Gisha')->setSize(10);
