...
ORDER  BY today_date";
        ...
        
               {
                ...
                if ($monthdate!='') {
                    $objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$ji].''.$row ,$monthdate);
                  $mermonth1=$alpa[$ji];

                  for($i=0; $i<3; $i++) { 
                  $objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yo].'4' ,$al[$i]);
                ...
                $objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$ji].''.$row ,'TOTAL');
...
$objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yo].'4' ,'Export');
$objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yo+1].'4' ,'Import');
$objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yo+2].'4' ,'Net');
$month_col=$alpa[$yo+2];
...
$objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yo+4].'2' ,'Plant');
...
$yrline=$alpa[$yrji];
$objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yrji].'2' ,'Yearly Meter Reading ');
$yrcnt=0;
...
FROM   Flexi_solar_inverters_daily where Plant_id=$solar_plant_id GROUP by YEAR(today_date)";
        ...
        
               {
                ...
                if ($YEARDATE1!='') {
                    $objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yrji].'3' ,'FY:'.$PREV.'-'.$YEARDATE1);
                  $meryear1=$alpa[$yrji];

                  for($i=0; $i<3; $i++) { 
                  
                  $objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yryo].'4' ,$yral[$i]);
 ...
 $objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yrji].'3' ,'Cumulative');
$objPHPExcel->getActiveSheet()->mergeCells($alpa[$yrji].'3'.':'.$alpa[$yrji+2].'3');
$objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yryo].'4' ,'Export');
$objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yryo+1].'4' ,'Import');
$objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yryo+2].'4' ,'Net Export');
...
////////////////DATAPART START/////////////////////////////////////////////////////////////////
 ...
 $Month_date=array();
 $cnt_da=0;
 $select_Inverter_monthly123="SELECT today_date,kwh_today ,Inverter_id,Inverter_start_time,Inverter_end_time FROM Flexi_solar_inverters_daily WHERE Plant_id=$solar_plant_id and DATE(today_date) BETWEEN '$PREVIOUSYR-01-01' and '$Current_year-$currentmonth-$Current_day' GROUP BY DATE(today_date),plant_id ORDER BY plant_id,today_date" ;
...
$row=5;
$select_MFM_daily="SELECT SUM(Energy_Export_today) AS Energy_Export_today,SUM(Energy_Import_today) AS Energy_Import_today,today_date FROM Flexi_solar_MFM_daily WHERE DATE(today_date) BETWEEN DATE('$PREVIOUSYR-01-01') AND DATE('$Current_year-$currentmonth-$Current_day') and MFM_Cumulative='1' and plant_id='$solar_plant_id' group by DATE(today_date) order by today_date";
                ...
                $objPHPExcel->setActiveSheetIndex(4)->setCellValue('B'.$row, number_format($Energy_Export_today));
                $objPHPExcel->setActiveSheetIndex(4)->setCellValue('E'.$row, number_format($Energy_Export_today));
                $objPHPExcel->setActiveSheetIndex(4)->setCellValue('C'.$row, number_format($Energy_Import_today));
                $objPHPExcel->setActiveSheetIndex(4)->setCellValue('D'.$row, '1000');
...
$montimpoty=8;
$montnet=9;
$objPHPExcel->setActiveSheetIndex(4)->setCellValue('G5',$solar_plant_name);
...
$select_MFM_MONTHLY1="SELECT SUM(Energy_Export_today) AS Energy_Export_today,SUM(Energy_Import_today) AS Energy_Import_today,today_date FROM Flexi_solar_MFM_daily WHERE DATE(today_date) BETWEEN DATE('$PREVIOUSYR-01-01') AND DATE('$Current_year-$currentmonth-$Current_day') and MFM_Cumulative='1' and plant_id='$solar_plant_id' group by YEAR(today_date),MONTH(today_date) order by today_date";
                ...
                $objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$monenergy].'5',number_format($Energy_Export_Monthly,2));
                $objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$montimpoty].'5', number_format($Energy_Import_Monthly,2));
                $objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$montnet].'5', number_format($netincome,2));
                ...
                $netincome='';
                 ...
                 $objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$monenergy].'5',number_format($Energy_Export_Monthly_sum,2));
                $objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$montimpoty].'5', number_format($Energy_Import_Monthly_sum,2));
                $objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$montnet].'5', number_format($netincome_sum,2));
...
$objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yearly_startline].'5',$solar_plant_name);
...
$select_MFM_yearly1="SELECT SUM(Energy_Export_today) AS Energy_Export_today,SUM(Energy_Import_today) AS Energy_Import_today,today_date FROM Flexi_solar_MFM_daily WHERE DATE(today_date) BETWEEN DATE('2017-01-01') AND DATE('$Current_year-$currentmonth-$Current_day') and MFM_Cumulative='1' and plant_id='$solar_plant_id' group by YEAR(today_date)";
                ...
                $objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yearexport].'5',number_format($Energy_Export_yearly,2));
                $objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yearimport].'5', number_format($Energy_Import_yearly,2));
                $objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yearnet].'5', number_format($netincomeyearly,2));
  ...
  $objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yearexport].'5',number_format($Energy_Export_yearly_sum,2));
  $objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yearimport].'5', number_format($Energy_Import_yearly_sum,2));
  $objPHPExcel->setActiveSheetIndex(4)->setCellValue($alpa[$yearnet].'5', number_format($netincomeyearly_sum,2));
