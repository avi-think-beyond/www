...
$objPHPExcel = new PHPExcel();
 ...
 $objPHPExcel->getActiveSheet()->getStyle('A2:N2')->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'E6B9B8'))))->getAlignment();
 $objPHPExcel->getActiveSheet()->getStyle('O2:V2')->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'FFFF00'))))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
 $objPHPExcel->getActiveSheet()->getStyle('W2:Z2')->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'E4AD7B'))))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
 $objPHPExcel->getActiveSheet()->getStyle('A2:Z2')->getFont()->setBold(true)->setSize(11);
 $objPHPExcel->getActiveSheet()->getStyle('A:Z')->getFont()->setBold(true)->setSize(10);
...
->setCellValue('A1',date("l jS \of F Y").' ENERGY PRODUCTION')
               ...
               ->setCellValue('B2', 'Inverter_1 (KWh)')
                ...
                ->setCellValue('H2', 'Inverter_7 (KWh)')
                ->setCellValue('I2', 'Inverter_8 (KWh)')
                ->setCellValue('J2', 'Inverter_9 (KWh)')
                ->setCellValue('K2', 'Inverter_10 (KWh)')
                ->setCellValue('L2', 'Inverter_11 (KWh)')
                ->setCellValue('M2', 'Inverter_12 (KWh)')
             
                              
                                ->setCellValue('N2', 'Total (KWh)')
                                ->setCellValue('O2'.$row, 'Metering_Panel_MFM1 - Enery Export (KWh)')
                                ->setCellValue('P2'.$row, 'Metering_Panel_MFM1 - Enery Import (KWh)')
                                ->setCellValue('Q2'.$row, 'Metering_Panel_MFM1 - Enery Export Till date (KWh)')
                                ->setCellValue('R2'.$row, 'Metering_Panel_MFM1 - Enery Import Till date (KWh)')

                                ->setCellValue('S2'.$row, 'Metering_Panel_MFM2 - Enery Export (KWh)')
                                ->setCellValue('T2'.$row, 'Metering_Panel_MFM2 - Enery Import (KWh)')
                                ->setCellValue('U2' .$row, 'Metering_Panel_MFM2 - Enery Export Till date (KWh)')
                                ->setCellValue('V2' .$row, 'Metering_Panel_MFM2 - Enery Import Till date (KWh)')
                               
                                ->setCellValue('W2'.$row, 'Irradiation today [GHI] (kWh/m2)')
                                ->setCellValue('X2'.$row, 'Irradiation today [DNI](kWh/m2)')
                                ->setCellValue('Y2'.$row, 'Specific Yield (kWh/kWp)')
                                ->setCellValue('Z2'.$row, 'Performance ratio (PR)');
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('N'.$row, $ENERGY_Generated_today);
$server_date_time='';
$Meter_id='';
$kwh_today='';
    $row++;
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('W'.$row, $irradiation);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('X'.$row, $irradiation_tilt1);
    $server_date_time='';
    $Meter_id='';
    $kwh_today='';
     $irradiation='';
...
// $objPHPExcel->setActiveSheetIndex(0)->setCellValue('A'.$row, $server_date_time);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('S'.$row, $Energy_Export_today);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('T'.$row, $Energy_import_today);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('U'.$row, $Energy_Export_total);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('V'.$row, $Energy_import_total);
