...
->setCellValue('A1',date("l jS \of F Y").' ENERGY PRODUCTION')
                ...
                ->setCellValue('AP2', 'MCR Inverter1(KWh)')
                ->setCellValue('AQ2', 'MCR Inverter2 (KWh)')
                ->setCellValue('AR2', 'MCR Inverter3 (KWh)')
                ->setCellValue('AS2', 'MCR Inverter4 (KWh)')
                ...
                ->setCellValue('AX2', 'ICR13 Inverter1 (KWh)')
