...
{
 $irradiation=$Block2_name_irradiation=$Block3_name_irradiation=$irradiation=round($row16['irradiation'],2);
	}
	...
	WHERE DATE(today_date) = CURRENT_DATE  and M_id='3' and plant_id='$plant_id'";
	$rs16=mysqli_query($conn2,$select_Irr) or die("error 101".mysqli_error($conn2));
	while($row16=mysqli_fetch_array($rs16))
	{
...
$PR_mfm=0;
	...
	// if($capcity!=0 && $capcity!=''){
	// $specific_yield_mfm = round(($Energy_Export_today/$capcity),2);
	// if($irradiation!=0){
	// //$PR=round(($specific_yield/$irradiation)*100);
	// 	$PR_mfm=round(($Energy_Export_today/($irradiation*$capcity))*100,1);
	// }else {
	// 	$PR_mfm=0;
	// }
	// }
...
// $ENERGY_Generated_today = $arr_ENERGY_Generated_today[1];
// $Block2_name_ENERGY_Generated_today = $arr_ENERGY_Generated_today[2];

 
// $PR_Inverter = $singl_PR_Inverter[1];
// $Block2_name_PR_Inverter = $singl_PR_Inverter[2];


// $specific_yield_inverter = $inv_specific_yield_inverter[1];
...
//exit;
// $mean_val = ($Energy_Export_today + $Block2_name_Energy_Export_today + $Block3_name_Energy_Export_today + $Block4_name_Energy_Export_today + $Block5_name_Energy_Export_today)/$cnt_mfm;
//  $mean_val = ($specific_yield_mfm + $Block2_name_specific_yield_mfm)/$cnt_mfm;

// $mean_Block1 = pow(($specific_yield_mfm - $mean_val),2);
...
/* echo "cnt_mfm".$cnt_mfm."<br>";
echo "specific_yield_mfm".$specific_yield_mfm."<br>";
echo "Block2_name_specific_yield_mfm".$Block2_name_specific_yield_mfm."<br>";
echo "mean_val".$mean_val."<br>";
echo "mean_Block1".$mean_Block1."<br>";
echo "mean_Block2".$mean_Block2."<br>";
echo "SD_block".$SD_block."<br>";
echo "CV_block".$CV_block."<br>";
exit;    */ 
