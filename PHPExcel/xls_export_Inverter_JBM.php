...
$objPHPExcel = new PHPExcel();
 ...
 $objPHPExcel->getActiveSheet()->getStyle('A2:V2')->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'E6B9B8'))))->getAlignment();
 $objPHPExcel->getActiveSheet()->getStyle('W2:AD2')->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'FFFF00'))))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
 $objPHPExcel->getActiveSheet()->getStyle('AE2:AH2')->applyFromArray(array('fill' => array('type' => PHPExcel_Style_Fill::FILL_SOLID,'color' => array('rgb' => 'E4AD7B'))))->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
 $objPHPExcel->getActiveSheet()->getStyle('A2:AH2')->getFont()->setBold(true)->setSize(11);
 $objPHPExcel->getActiveSheet()->getStyle('A:AH')->getFont()->setBold(true)->setSize(10);
...
->setCellValue('A1',date("l jS \of F Y").' ENERGY PRODUCTION')
               ...
               ->setCellValue('B2', 'MCR Inverter1 (KWh)')
                ->setCellValue('C2', 'MCR Inverter 2 (KWh)')
                ->setCellValue('D2', 'MCR Inverter 3 (KWh)')
                ->setCellValue('E2', 'MCR Inverter 4 (KWh)')
                ...
                ->setCellValue('N2', 'Block3 Inverter1 (KWh)')
                ->setCellValue('O2', 'Block3 Inverter2 (KWh)')
                ->setCellValue('P2', 'Block3 Inverter3 (KWh)')
                ->setCellValue('Q2', 'Block3 Inverter4 (KWh)')
                ->setCellValue('R2', 'Block4 Inverter1 (KWh)')
                ->setCellValue('S2', 'Block4 Inverter2 (KWh)')
                ->setCellValue('T2', 'Block4 Inverter3 (KWh)')
                ->setCellValue('U2', 'Block4 Inverter4 (KWh)')
                ...
                // ->setCellValue('AY2', 'Inverter 50 (KWh)')
                                ...
                                ->setCellValue('V2', 'Total (KWh)')
                                ->setCellValue('W2'.$row, 'OG_1 - Enery Export (KWh)')
                                ->setCellValue('X2'.$row, 'OG_1 - Enery Import (KWh)')
                                ->setCellValue('Y2'.$row, 'OG_1 - Enery Export Till date (KWh)')
                                ->setCellValue('Z2'.$row, 'OG_1 - Enery Import Till date (KWh)')

                                ->setCellValue('AA2'.$row, 'OG_2 - Enery Export (KWh)')
                                ->setCellValue('AB2'.$row, 'OG_2 - Enery Import (KWh)')
                                ->setCellValue('AC2' .$row, 'OG_2 - Enery Export Till date (KWh)')
                                ->setCellValue('AD2' .$row, 'OG_2 - Enery Import Till date (KWh)')
                               
                                ->setCellValue('AE2'.$row, 'Irradiation today [GHI] (kWh/m2)')
                                ->setCellValue('AF2'.$row, 'Irradiation today [DNI](kWh/m2)')
                                ->setCellValue('AG2'.$row, 'Specific Yield (kWh/kWp)')
                                ->setCellValue('AH2'.$row, 'Performance ratio (PR)');
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('V'.$row, $ENERGY_Generated_today);
$server_date_time='';
$Meter_id='';
$kwh_today='';
    $row++;
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AE'.$row, $irradiation);
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AF'.$row, $irradiation_tilt1);
    $server_date_time='';
    $Meter_id='';
    $kwh_today='';
     $irradiation='';
...
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('W'.$row, $Energy_Export_today);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('X'.$row, $Energy_import_today);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Y'.$row, $Energy_Export_total);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('Z'.$row, $Energy_import_total);
...
// $objPHPExcel->setActiveSheetIndex(0)->setCellValue('A'.$row, $server_date_time);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AA'.$row, $Energy_Export_today);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AB'.$row, $Energy_import_today);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AC'.$row, $Energy_Export_total);
$objPHPExcel->setActiveSheetIndex(0)->setCellValue('AD'.$row, $Energy_import_total);
// $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AG'.$row, $specific_yield);
// $objPHPExcel->setActiveSheetIndex(0)->setCellValue('AH'.$row, $PR);
$Energy_Export_today='';
$Energy_import_today='';
$server_date_time='';
$Meter_id='';
