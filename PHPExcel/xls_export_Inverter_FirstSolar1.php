...
->setCellValue('A1',date("l jS \of F Y").' ENERGY PRODUCTION')
                ...
                ->setCellValue('B2', 'IC1 Inverter1 (KWh)')
                ->setCellValue('C2', 'IC1 Inverter2 (KWh)')
                ->setCellValue('D2', 'IC1 Inverter3 (KWh)')
                ->setCellValue('E2', 'IC1 Inverter4 (KWh)')
                ->setCellValue('F2', 'IC2 Inverter1 (KWh)')
                ->setCellValue('G2', 'IC2 Inverter2 (KWh)')
                ->setCellValue('H2', 'IC2 Inverter3 (KWh)')
                ->setCellValue('I2', 'IC2 Inverter4 (KWh)')
                ->setCellValue('J2', 'MCR Inverter1 (KWh)')
                ->setCellValue('K2', 'MCR Inverter2 (KWh)')
