...
<body>
   <div style="width: 100%; margin-top: 5px; margin-bottom: 15px; padding: 2px; padding-left: 20px; border: solid 1px #dcd5d5;box-shadow: inset 1px 1px 12px 2px #d2cdcd;">
    ...
    color: #398ab9;
    font-size: 13px;
    font-weight: 600;">Profit & Loss</h2>
    </div>
...
<div class="container-fluid" style="padding-left: 0px;">
  <div class="container-fluid" style="padding-left: 0px;">
    <div class="row">
      <div class="col-md-12">
        <div class="col-md-12">
          <label>From Date : <input type="text" class="in" id="in" name=""></label>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="col-md-12">
          <label>To Date :<input type="text" name="" class="in" id="in"></label>
          <label>Enter Place :-<input type="text" class="in" id="in" name=""></label> 
