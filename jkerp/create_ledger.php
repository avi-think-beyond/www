...
<body>
   <div style="margin-top: 5px; width: 100%; margin-bottom: 15px; padding: 2px; padding-left: 20px; border: solid 1px #dcd5d5;box-shadow: inset 1px 1px 12px 2px #d2cdcd;">
    ...
    color: #398ab9;
    font-size: 13px;
    font-weight: 600;"><b>MASTER »» CREATE NEW ACCOUNT »»</b></h2>
    </div>
  ...
  <div style=" padding: 1%; height: auto; box-shadow: 1px -1px 13px 3px #b6bbbf; margin-left: auto; margin-right: auto;">  
    ...
    <div class="row">
       ...
       <br>
         <div class="row">
             ...
             Select Section
               ...
               <select name="" style="width:90px;margin-top: 0px;height: 24px;">
                </select>
              </div>
            <div class="col-md-4">
              <label >
             ...
             <input type="text" class="in" id="in" name="" style="height: 25px;">      
            </div>
        </div>
          </div>
      ...
      <div class="col-md-3">
        <div class="row">
         ...
         <div class="row t2">
            ...
            <div class="col-md-2">
              <input type="text" class="in" id="in" name="" style="width: 50px;" >      
            </div>
              <div class="col-md-4">
     ...
     <br>
        <div class="row t2">
          <div class="col-md-3">
          <input type="button" id="in" value="Submit" class="btn" style="font-size: 13px; color: #fff; height: 30px; background-color: #0d93e2;font-weight: bold;margin: 5px; "> 
          </div>
            
          <div class="col-md-3">
          <input type="Reset" id="in" value="Reset" class="btn" style="font-size: 13px; color: #fff; height: 30px; background-color: #0d93e2;font-weight: bold;margin: 5px;">    
           </div>
        </div>
      </div>
    <div class="col-md-6">
      <div class="row">
        <p id="in" style="margin: 20px;">Total Dr.  0   Total Cr. 0   Rs. 0 Dr. Excess (Difference in Opening balance only)
        </p>
...
<div class="">
  <div class="panel panel-default border">
    ...
    <P value="" style="background-color:#497191 ;width: 100%;color: white">&nbsp;&nbsp;&nbsp;Account Head</P>
  <select size="10" style="width: 100%;height: 83%; position: relative;margin-top: -10px;" >
  <option value=""  >Source Holder's Fund</option>
  <option value="" >Share Capital</option>
  <option value="">Reserve and Surplus</option>
  <option value="" style="color:#0d93e2;">Reserve and Surplus</option>
  <option value="" style="color:#0d93e2;">Profit and Loss account</option>
...
<div class="">
  <div class="panel panel-default border">
    ...
    <div class="panel-body">
     <P value="" style="background-color:#497191 ;width: 100%;color: white">&nbsp;&nbsp;Account Name</P>
      <select size="10" style="width: 100%;height: 83%; position: relative;margin-top: -10px;" >
