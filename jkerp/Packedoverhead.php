...
<div style=" width: 96%; margin-right: auto; margin-left: auto;">
        ...
        <div class="container-fluid" style="padding-left: 0px;">
            ...
            <div class="row" style="padding-left: 6px;padding-top: 6px;">
                <div class="col-md-2" style="padding-top: 6px;">
                    <label style="float: left;padding-left: 10px;">Unique Barcode</label>
                    <label><input type="checkbox" name="" style="margin-left: 12px;"></label>
                    
                </div>
                <div class="col-md-3" style="padding-top: 6px;">
                    <label style="float: left;">Item Code as Barcode</label>
    ...
    font-size: 13px !important; background-color:#0d93e2;/*width: 150px;*/" id="in">Purchase Items</button>
                </div>
            </div>
        </div>
