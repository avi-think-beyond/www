...
@media only screen and (max-width: 768px) {
       ...
       <div class="row" style="margin-top: 5px;">
        ...
        <div class="col-md-6">
          <div class="row">
            ...
            <div class="col-md-5">
             <div class="row">
              <div class="col-md-6">  <input type="button" id="" value="Update" class="btn btn-success" style="height: 30px; font-size: 12px;" autocomplete="off"></div>
              <div class="col-md-6"> <input type="button" id="" value="Reset" class="btn" style="background-color: #0d93e2; color: #fff; height: 30px; font-size: 12;" autocomplete="off"></div>
              </div>
            </div> 
          </div>
        </div>
  ...
  <div style="width: 100%; margin-bottom: 15px; padding: 2px; padding-left: 20px; border: solid 1px #dcd5d5;box-shadow: inset 1px 1px 12px 2px #d2cdcd;">
    ...
    color: #398ab9;
    font-size: 13px;
    font-weight: 600;"> Sales Overhead List </h2>
</div>
  <div style="width: 98%; overflow: hidden; margin-left: auto; margin-right: auto;">
  <div ><button onclick="exportTableToExcel('tblData')"  class="btn" style="background-color: #0d93e2; margin-bottom: 10px; float: right; color: #fff; height: 30px; font-size: 12;" id="in">Export To Excel</button></div>
