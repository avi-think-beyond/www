...
<div style=" width: 96%; margin-right: auto; margin-left: auto;">
 <div style="width: 100%; margin-bottom: 15px; padding: 2px; padding-left: 20px; border: solid 1px #dcd5d5;box-shadow: inset 1px 1px 12px 2px #d2cdcd; margin-bottom: 20px;">
    ...
    color: #398ab9;
    font-size: 13px;
    font-weight: 600;">Supplier Balance Report</h2>
    </div>
      ...
      <div class="col-md-4">
        ...
        <div class="col-md-4" >
              <select style="height:30px;" >
               <option selected="selected" value="All Currency">All Currency</option>
 ...
 <div class="col-md-6">
        ...
        <div class="col-md-2">
         ...
         <div class="col-md-3">
           <button type="button" class="btn btn-primary" style="background-color: #0d93e2;height: 30px;font-size: 12px;font-weight: bold;" id="in" >All Supplier Ageing</button>
          </div>
        <div class="col-md-2" >
