        ...
        <tbody>
            ...
            <tr>
                                    ...
                                    <tbody>
                                        ...
                                        $i=1;
                                        $sql=mysqli_query($conn,"SELECT * FROM expenses_details where user='1' ORDER BY id DESC");
                                        ...
                                        ?>
                                         ...
                                         <thead>
                                            <tr >
                                                ...
                                                $countquery=mysqli_query($conn,"SELECT count(*) as count FROM expenses_details") or die(mysqli_error($conn)); 
                                               ...
                                               echo $totalcount=$countdata['count'];
                                                ...
                                                <?php  
                                                $query=mysqli_query($conn,"SELECT sum(amount) as total FROM expenses_details") or die(mysqli_error($conn)); 
