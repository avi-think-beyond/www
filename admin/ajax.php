...
if(isset($_POST['type']) && $_POST['type']=='add_expense')
{
	...
	mysqli_query($conn,"INSERT INTO expenses_details(bill_no,bill_name,amount,party_name,address,mobile,payment_method,date,invoice_no,user) VALUES('$bill_no','$bill_name','$amount','$party_name','$exp_address','$exp_mobile','$payment','$date','$invoice_no','1')") or die(mysqli_error($conn));
