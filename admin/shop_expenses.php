            ...
            <div class="tab-pane animated fadeInUpShort show active" id="v-pills-all" role="tabpanel" aria-labelledby="v-pills-all-tab">
                <div class="row">
                             <div class="col-md-2 label" style="background-color: #234b0f;color: #fff;font-size: 18px;border-bottom-right-radius: 21px;border-top-right-radius: 21px;border-bottom: 11px solid #478828;">
                                ...
                                <span class="s-8">Shop Expenses</span>
                            </div>
                             <div class="col-md-10">
                             </div>
                        </div>
        ...
        <tbody>
            ...
            <tr>
                                        ...
                                        <thead>
                                            <tr >
                                                ...
                                                <th><label style="width: 35px;">Sr No</label> </th>
                                                 <th><label style="width: 100px;">Shop</label></th>
                                                 <th><label style="width: 100px;">User</label></th>
                                    ...
                                    <tbody>
                                        ...
                                        $i=1;
                                        $sql=mysqli_query($conn,"SELECT e.* ,u.id,u.shop,u.user_name FROM expenses_details e join users u ON e.user=u.id  where e.user!='1' ORDER BY e.id DESC");
                                        ...
                                        ?>
                                         ...
                                         <thead>
                                            <tr >
                                                ...
                                                $countquery=mysqli_query($conn,"SELECT count(*) as count FROM expenses_details where user!='1'") or die(mysqli_error($conn)); 
                                               ...
                                               echo $totalcount=$countdata['count'];
                                                ...
                                                <?php  
                                                $query=mysqli_query($conn,"SELECT sum(amount) as total FROM expenses_details where user!='1'") or die(mysqli_error($conn)); 
                                                $data=mysqli_fetch_assoc($query); 
